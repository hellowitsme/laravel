...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header font-weight-bold">{{ __('Job Register') }}</div>

                    <div class="card-body">
                        <form method="POST" action="{{ route('jobs.create') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="experience" type="text" class="form-control @error('experience') is-invalid @enderror" name="experience" value="{{ old('experience') }}" autofocus>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                <textarea name="detail" id="detail" cols="35" rows="5" value="{{ old('$detail') }}" class="form-control @error('detail') is-invalid @enderror">
                                </textarea>
